...
public class HttpHelper {
    ...
    public String sendStream(String host, String path, String contentType, InputStream data, int contentLength,
        boolean useAccesstoken, String requestMethod) throws IOException {
        URL obj = URI.create(host + path)
            .toURL();
        URLConnection con = obj.openConnection();
        HttpURLConnection http = (HttpURLConnection) con;
    ...
    public void sendStreamAsync(String host, String path, String contentType, int contentLength, InputStream data,
        boolean useAccesstoken, String requestMethod, DataCallback callback) throws IOException {
        if (callback == null) {
    ...
    public void sendRequestAsync(String host, String path, JSONObject data, String requestMethd, DataCallback callback)
        throws IOException {
        sendRequestAsync(host, path, data, callback, accessTokenSupplier.get() != null, requestMethd);
    }

    public void sendRequestAsync(String host, String path, JSONObject data, DataCallback callback,
        boolean useAccesstoken, String requestMethod) throws IOException {
        if (callback == null) {
            System.err.println("callback must not be null!");
            return;
