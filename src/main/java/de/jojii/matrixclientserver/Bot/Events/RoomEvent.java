...
public class RoomEvent {
    ...
    public static List<RoomEvent> parseAllEvents(JSONObject object) {
        ...
        for (String pointTop : POINTS_TOP) {
            ...
            if (!object.has("rooms")) continue;

            final JSONObject rooms = object.getJSONObject("rooms");

            if (!rooms.has(pointTop)) continue;
            ...
            while (keys.hasNext()) {
                ...
                for (String point : POINTS) {
                    ...
                    JSONArray timeline = room.getJSONObject(point)
                        .getJSONArray("events");
    ...
    public static RoomEvent fetchRoomEvent(JSONObject event, String key) {
        ...
        return new RoomEvent(event, event.getString("type"), event_id, sender, key, event.getJSONObject("content"));
    }
